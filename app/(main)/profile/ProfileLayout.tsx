...
export function ProfileLayout({ children }: ProfileLayoutProps) {
    ...
    // Compute display values from profile
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[320px,1fr] gap-3 sm:gap-4 lg:gap-8">
                ...
                <aside className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    >
                        <Button
                            variant="outline"
                            className="w-full justify-center gap-2 rounded-2xl border-gray-200 text-slate-700 hover:bg-white hover:text-red-600 transition-colors duration-400"
