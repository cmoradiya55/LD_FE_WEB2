...
import PhotosUpload from '@/app/sellCar/PhotosUpload/PhotosUpload';
import {
  fetchSellCarBrands,
  fetchSellCarModels,
  fetchSellCarYears,
  ...
  const getOptionsForStep = async (stepId: StepId): Promise<StepOption[]> => {
    ...
    switch (stepId) {
      ...
      case 'model': {
        ...
        const models = await fetchSellCarModels(selections.brand, selections.year);
      ...
      case 'variant': {
        if (!selections.brand || !selections.year || !selections.model) return [];
