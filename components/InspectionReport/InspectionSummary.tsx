          ...
          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-200/60">
            <div className="flex items-start gap-2 p-2 rounded-lg bg-slate-50/50 border border-slate-200/60 hover:border-blue-300/50 hover:shadow-sm transition-all duration-200">
              ...
              <div className="flex-shrink-0">
                {carDetails.rc_image ? (
                  <div className="w-16 h-16 rounded border border-blue-200/60 bg-white overflow-hidden relative">
                    <ImagePreview
            ...
            <div className="flex items-start gap-2 p-2 rounded-lg bg-slate-50/50 border border-slate-200/60 hover:border-emerald-300/50 hover:shadow-sm transition-all duration-200">
              ...
              <div className="flex-shrink-0">
                {carDetails.insurance_image ? (
                  <div className="w-16 h-16 rounded border border-emerald-200/60 bg-white overflow-hidden relative">
                    <ImagePreview
                    ...
                    const renderFieldCard = (field: FieldDefinition, fieldData: FieldData) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-shrink-0 w-20 h-20 rounded-lg border border-slate-200 bg-slate-50/60 flex items-center justify-center overflow-hidden relative">
                            {hasImage ? (
                              <ImagePreview
                                src={image}
                                alt={field.label}
